...
const departments: Department[] = [
  {
    ...
    descAr:
      "يُعنى القسم بتأهيل كوادر متخصصة في مجال الحاسوب والبرمجة وتقنية المعلومات وفق أحدث المناهج العلمية والعملية.",
    descEn:
      "The department prepares specialized cadres in computer science, programming, and information technology using the latest academic and practical curricula.",
    stats: {
      ar: ["٤ سنوات", "٢٠٠+ خريج", "١٢ مادة"],
      en: ["4 Years", "200+ Graduates", "12 Subjects"],
    },
    color: "#2589c4",
  },
  {
    ...
    descAr:
      "يختص بإعداد كوادر إدارية قادرة على قيادة المؤسسات وتطوير استراتيجياتها وفق المعايير الإدارية الحديثة.",
    descEn:
      "Specializes in preparing administrative cadres capable of leading institutions and developing strategies according to modern management standards.",
    stats: {
      ar: ["٤ سنوات", "٣٠٠+ خريج", "١٤ مادة"],
      en: ["4 Years", "300+ Graduates", "14 Subjects"],
    },
    color: "#1a6b9a",
  },
  {
    ...
    nameEn: "Accounting",
    descAr:
      "يُدرّب الطلاب على أسس المحاسبة المالية والإدارية والتدقيق وفق المعايير الدولية لإعداد محاسبين متميزين.",
    descEn:
      "Trains students in financial and managerial accounting and auditing according to international standards to prepare distinguished accountants.",
    stats: {
      ar: ["٤ سنوات", "٢٥٠+ خريج", "١٣ مادة"],
      en: ["4 Years", "250+ Graduates", "13 Subjects"],
    },
    color: "#b8860b",
  },
];
...
export default function DepartmentsPage() {
  ...
  const statsBar = isAr
    ? [
        { num: "٦", lbl: "أقسام أكاديمية" },
        { num: "+١٣٠٠", lbl: "طالب وطالبة" },
        { num: "+٨٠", lbl: "عضو هيئة تدريس" },
        { num: "+١٣٠٠", lbl: "خريج" },
      ]
    : [
        { num: "6", lbl: "Departments" },
        { num: "1300+", lbl: "Students" },
        { num: "80+", lbl: "Faculty Members" },
        { num: "1300+", lbl: "Graduates" },
      ];
  ...
  return (
    ...
    >
      ...
      <div
        style={{
          background:
            "linear-gradient(145deg, #e4f1fa 0%, #d0e8f5 60%, #c2e0f2 100%)",
        ...
        <div style={{ maxWidth: 500 }}>
          ...
          <div
            style={{
              width: 60,
              height: 4,
              background: "linear-gradient(90deg, #0056d4, #b8860b)",
              borderRadius: 2,
              marginBottom: 14,
            }}
          />
          <p
            style={{ fontSize: "0.95rem", color: "#3d607a", lineHeight: 1.95 }}
          >
            {isAr
      ...
      >
        {statsBar.map((s, i) => (
          ...
          >
            ...
            <div
              style={{ fontSize: "0.78rem", color: "rgba(255,255,255,0.65)" }}
            >
              {s.lbl}
            </div>
          </div>
          ...
          filtered.map((dept) => (
            <div
              ...
              style={{
                ...
                cursor: "pointer",
                transform:
                  hoveredId === dept.id ? "translateY(-5px)" : "translateY(0)",
                transition:
